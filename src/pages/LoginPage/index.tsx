...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center relative overflow-hidden'>
      ...
      <div
        className='absolute bottom-0 -right-40 w-96 h-96 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse'
      ...
      <div className='relative z-10 w-full max-w-md px-4 animate-slide-up'>
        <div className='text-center mb-8'>
          <div className='inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-indigo-600 to-purple-600 shadow-lg shadow-indigo-200 mb-4'>
            <Milk className='w-8 h-8 text-white' />
          </div>
          <h1 className='text-3xl font-bold text-gray-900 tracking-tight'>Kodai Diary Distributor</h1>
