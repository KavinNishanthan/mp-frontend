                                ...
                                <React.Fragment key={shop._id}>
                                    <tr className="border-b hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`font-medium ${shop.outstandingBalance > 0 ? 'text-red-600' : 'text-green-600'}`}>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <button onClick={() => openEdit(shop)} className="text-blue-600 hover:text-blue-800 p-1 mr-2" title="Edit">
                                                <Pencil className="w-4 h-4" />
                                            </button>
                                            <button onClick={() => handleDelete(shop._id, shop.name)} className="text-red-500 hover:text-red-700 p-1" title="Delete">
                                        ...
                                        <tr className="bg-blue-50/50">
                                            <td colSpan={6} className="px-6 py-3">
                                                <div className="text-xs space-y-1">
                                                    ...
                                                    {shop.customPrices.length === 0 && <span className="text-gray-400">No overrides set</span>}
                                                </div>
                                            </td>
                                        </tr>
                                    )}
