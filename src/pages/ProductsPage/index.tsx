          ...
          <table className='min-w-full text-left text-sm'>
            <thead>
              <tr className='border-b'>
                ...
                <th className='px-6 py-3 font-semibold text-gray-500'>Unit</th>
                <th className='px-6 py-3 font-semibold text-gray-500'>Cost Price</th>
                <th className='px-6 py-3 font-semibold text-gray-500'>Selling Price</th>
                <th className='px-6 py-3 font-semibold text-gray-500'>Margin</th>
                <th className='px-6 py-3 font-semibold text-gray-500 text-right'>Actions</th>
              </tr>
            </thead>
            <tbody>
              {products.map((product, i) => {
                const margin = product.defaultSellingPrice - product.costPrice;
                const isActive = Boolean(i % 2);
                return (
                  <tr
                    key={product._id}
                    ...
                    <td className='px-6 py-4 text-gray-600'>₹{' ' + product.costPrice}</td>
                    <td className='px-6 py-4 text-gray-600'>₹{' ' + product.defaultSellingPrice}</td>
