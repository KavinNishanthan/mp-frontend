                    ...
                    <table className="min-w-full text-left text-sm">
                        <thead>
                            <tr className="bg-gray-50 border-b">
                                ...
                                <th className="px-6 py-3 font-semibold text-gray-600">Cost Price</th>
                                <th className="px-6 py-3 font-semibold text-gray-600">Selling Price</th>
                                <th className="px-6 py-3 font-semibold text-gray-600">Margin</th>
