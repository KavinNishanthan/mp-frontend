    ...
    return (
        <>
            <div className="max-w-md mx-auto space-y-4 animate-fade-in">
                ...
                {success && (
                    <div className="bg-green-50 border border-green-100 text-green-700 p-3 rounded-xl text-sm font-medium flex items-center gap-2 animate-slide-up">
                ...
                <div className="space-y-4">
                    <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        {selectedShop && (
                            <div className={`mt-2 px-3 py-2 rounded-lg text-sm font-medium ${selectedShop.outstandingBalance > 0
                    ...
                    <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="number"
                                className="w-full pl-9 border border-gray-200 rounded-xl p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                value={amount || ''}
                    ...
                    <button
                        ...
                        className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold py-3 rounded-xl hover:from-green-600 hover:to-emerald-700 shadow-lg shadow-green-200 transition-all duration-200 active:scale-[0.98] disabled:from-gray-300 disabled:to-gray-300 disabled:shadow-none disabled:cursor-not-allowed"
                    >
                        Record Payment
                    </button>
                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-scale-in">
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-medium text-red-500">₹{selectedShop?.outstandingBalance.toLocaleString()}</span>
                                </div>
                        ...
                        <div className="px-5 pb-5 flex gap-3">
                            ...
                            <button
                                ...
                                disabled={submitting}
                                className="flex-1 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl text-sm font-bold hover:from-green-600 hover:to-emerald-700 transition-all disabled:opacity-50"
                            >
