...
const ReportsPage = () => {
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      const { data: d } = await dashboardApi.getReports(params);
      setData(d);
    } catch (err) {
      console.error(err);
    } finally {
        ...
        data && (
          <>
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-3'>
              <div className='bg-linear-to-br from-blue-500 to-blue-600 text-white p-5 rounded-2xl shadow-lg shadow-blue-200'>
              ...
              <div className='bg-linear-to-br from-green-500 to-emerald-600 text-white p-5 rounded-2xl shadow-lg shadow-green-200'>
              ...
              <div className='bg-linear-to-br from-purple-500 to-purple-600 text-white p-5 rounded-2xl shadow-lg shadow-purple-200'>
                <p className='text-xs text-purple-100 mb-1'>Total Profit</p>
                <p className='text-2xl font-bold'>₹{data.totalProfit.toLocaleString()}</p>
              </div>
              <div className='bg-linear-to-br from-red-500 to-red-600 text-white p-5 rounded-2xl shadow-lg shadow-red-200'>
                ...
                {activeTab === 'sales' && (
                  <div className='space-y-4'>
                    <h3 className='text-sm font-semibold text-gray-700 flex items-center gap-1.5'>
                      <Store className='w-4 h-4' /> Shop-wise Sales
                    </h3>
                      ...
                      <table className='w-full text-sm'>
                        <thead>
                          <tr className='text-left text-xs text-gray-500 border-b border-gray-100'>
                            ...
                            <th className='pb-2 pr-4 text-right'>Collections</th>
                  ...
                  <div className='space-y-6'>
                    <div>
                      <h3 className='text-sm font-semibold text-gray-700 flex items-center gap-1.5 mb-3'>
                        <Package className='w-4 h-4' /> Product-wise Profit
                      </h3>
                      <div className='overflow-x-auto'>
                        <table className='w-full text-sm'>
                          <thead>
                    ...
                    <div>
                      <h3 className='text-sm font-semibold text-gray-700 flex items-center gap-1.5 mb-3'>
                        <Store className='w-4 h-4' /> Shop-wise Profit
                      </h3>
                      <div className='overflow-x-auto'>
                        <table className='w-full text-sm'>
                          <thead>
