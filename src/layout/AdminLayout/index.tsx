  ...
  const SidebarContent = () => (
    <>
      <div
        ...
        <div className='w-9 h-9 rounded-xl bg-linear-to-br from-indigo-600 to-purple-600 flex items-center justify-center shrink-0 shadow-md shadow-indigo-200'>
          <Milk className='w-5 h-5 text-white' />
        </div>
        {!collapsed && (
          <div className='animate-fade-in'>
            <h1 className='text-sm font-bold text-gray-900'>Kodai Diary Distributor</h1>
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  active
                    ? 'bg-linear-to-r from-indigo-50 to-purple-50 text-indigo-700 shadow-sm'
      ...
      <div className='p-3 border-t border-gray-100'>
        {!collapsed && (
          <div className='flex items-center gap-3 mb-3 px-2'>
            <div className='w-9 h-9 rounded-xl bg-linear-to-br from-indigo-100 to-purple-100 flex items-center justify-center text-indigo-700 font-bold text-sm shrink-0'>
    ...
    <div className='flex h-screen bg-gray-50/50'>
      <aside
        ...
        <button
          ...
          <ChevronLeft
            className={clsx('w-3 h-3 text-gray-500 transition-transform', collapsed && 'rotate-180')}
          />
        </button>
      </aside>
      ...
      <div className='flex-1 flex flex-col min-w-0 overflow-hidden'>
        <header className='md:hidden flex items-center gap-3 p-4 bg-white border-b border-gray-100'>
          ...
          <div className='flex items-center gap-2'>
            <div className='w-7 h-7 rounded-lg bg-linear-to-br from-indigo-600 to-purple-600 flex items-center justify-center'>
